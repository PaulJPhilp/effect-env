...
export interface CompiledEnv<Server extends EnvRecord, Client extends EnvRecord> {
 ...
 */
export interface ValidationResult<Server extends EnvRecord, Client extends EnvRecord> {
    readonly server: Server;
    readonly client: Client;
}
